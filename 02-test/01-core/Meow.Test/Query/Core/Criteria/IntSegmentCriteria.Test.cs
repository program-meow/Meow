...
namespace Meow.Test.Query.Core.Criteria {
    ...
    public class IntSegmentCriteriaTest {
        ...
        public void TestGetPredicate() {
            IntSegmentCriteria<SampleAggregateRoot, int> criteria = new IntSegmentCriteria<SampleAggregateRoot, int>( t => t.Tel, 1, 10 );
            Assert.Equal( "t => ((t.Tel >= 1) AndAlso (t.Tel <= 10))", criteria.GetPredicate().ToString() );

            IntSegmentCriteria<SampleAggregateRoot, int?> criteria2 = new IntSegmentCriteria<SampleAggregateRoot, int?>( t => t.Age, 1, 10 );
        ...
        public void TestGetPredicate_MinGreaterMax() {
            IntSegmentCriteria<SampleAggregateRoot, int> criteria = new IntSegmentCriteria<SampleAggregateRoot, int>( t => t.Tel, 10, 1 );
            Assert.Equal( "t => ((t.Tel >= 1) AndAlso (t.Tel <= 10))", criteria.GetPredicate().ToString() );

            IntSegmentCriteria<SampleAggregateRoot, int?> criteria2 = new IntSegmentCriteria<SampleAggregateRoot, int?>( t => t.Age, 10, 1 );
            Assert.Equal( "t => ((t.Age >= 1) AndAlso (t.Age <= 10))", criteria2.GetPredicate().ToString() );
        }
        ...
        public void TestGetPredicate_MaxIsNull() {
            IntSegmentCriteria<SampleAggregateRoot, int> criteria = new IntSegmentCriteria<SampleAggregateRoot, int>( t => t.Tel, 1, null );
            Assert.Equal( "t => (t.Tel >= 1)", criteria.GetPredicate().ToString() );

            IntSegmentCriteria<SampleAggregateRoot, int?> criteria2 = new IntSegmentCriteria<SampleAggregateRoot, int?>( t => t.Age, 1, null );
        ...
        public void Test_BothNull() {
            IntSegmentCriteria<SampleAggregateRoot, int> criteria = new IntSegmentCriteria<SampleAggregateRoot, int>( t => t.Tel, null, null );
            Assert.Null( criteria.GetPredicate() );

            IntSegmentCriteria<SampleAggregateRoot, int?> criteria2 = new IntSegmentCriteria<SampleAggregateRoot, int?>( t => t.Age, null, null );
