...
namespace Meow.Test.Query.Core.Criteria {
    ...
    public class DateSegmentCriteriaTest {
        ...
        public void TestGetPredicate() {
            ...
            var criteria = new DateSegmentCriteria<SampleAggregateRoot, DateTime>( t => t.DateValue, _min, _max );
            ...
            var criteria2 = new DateSegmentCriteria<SampleAggregateRoot, DateTime?>( t => t.NullableDateValue, _min, _max );
        ...
        public void TestGetPredicate_Boundary() {
            ...
            result.Append( "t => ((t.DateValue > Convert(Parse(\"2000/1/1 0:00:00\"), DateTime))" );
            result.Append( " AndAlso (t.DateValue < Convert(Parse(\"2000/1/3 0:00:00\"), DateTime)))" );
            var criteria = new DateSegmentCriteria<SampleAggregateRoot, DateTime>( t => t.DateValue, _min, _max, Boundary.Neither );
            Assert.Equal( result.ToString(), criteria.GetPredicate().ToString() );

            result = new StringBuilder();
            result.Append( "t => ((t.DateValue >= Convert(Parse(\"2000/1/1 0:00:00\"), DateTime))" );
            result.Append( " AndAlso (t.DateValue < Convert(Parse(\"2000/1/3 0:00:00\"), DateTime)))" );
            criteria = new DateSegmentCriteria<SampleAggregateRoot, DateTime>( t => t.DateValue, _min, _max, Boundary.Left );
            Assert.Equal( result.ToString(), criteria.GetPredicate().ToString() );

            result = new StringBuilder();
            result.Append( "t => ((t.NullableDateValue > Convert(Parse(\"2000/1/1 0:00:00\"), Nullable`1))" );
            result.Append( " AndAlso (t.NullableDateValue <= Convert(Parse(\"2000/1/3 0:00:00\"), Nullable`1)))" );
            var criteria2 = new DateSegmentCriteria<SampleAggregateRoot, DateTime?>( t => t.NullableDateValue, _min, _max,Boundary.Right );
            Assert.Equal( result.ToString(), criteria2.GetPredicate().ToString() );

            result = new StringBuilder();
            result.Append( "t => ((t.NullableDateValue >= Convert(Parse(\"2000/1/1 0:00:00\"), Nullable`1))" );
            result.Append( " AndAlso (t.NullableDateValue <= Convert(Parse(\"2000/1/3 0:00:00\"), Nullable`1)))" );
            criteria2 = new DateSegmentCriteria<SampleAggregateRoot, DateTime?>( t => t.NullableDateValue, _min, _max, Boundary.Both );
            Assert.Equal( result.ToString(), criteria2.GetPredicate().ToString() );
        }
    }
}
