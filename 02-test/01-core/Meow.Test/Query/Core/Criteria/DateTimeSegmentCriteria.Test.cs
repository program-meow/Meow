...
namespace Meow.Test.Query.Core.Criteria {
    ...
    public class DateTimeSegmentCriteriaTest {
        ...
        public void TestGetPredicate() {
            ...
            var criteria = new DateTimeSegmentCriteria<SampleAggregateRoot, DateTime>( t => t.DateValue, _min, _max );
            ...
            var criteria2 = new DateTimeSegmentCriteria<SampleAggregateRoot, DateTime?>( t => t.NullableDateValue, _min, _max );
