...
namespace Meow.Test.Extension.Helper
{
    ...
    //    public LambdaTest()
    //    {
    //        _parameterExpression = SystemExpression.Parameter(typeof(Sample), "t");
    //        _expression1 = _parameterExpression.Property("StringValue").Call("Contains", SystemExpression.Constant("A"));
    //        _expression2 = _parameterExpression.Property("NullableDateValue")
    //                .Property("Value")
    //                .Property("Year")
    //                .Greater(SystemExpression.Constant(2000));
    //    }
    ...
    //    /// 表达式1
    //    /// </summary>
    //    private SystemExpression _expression1;

    //    /// <summary>
    //    /// 表达式2
    //    /// </summary>
    //    private SystemExpression _expression2;
