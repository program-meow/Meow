...
public class JsonStringLocalizerFactory : IStringLocalizerFactory {
    ...
    /// <inheritdoc />
    public IStringLocalizer Create( SystemType resourceSource ) {
        resourceSource.CheckNull( nameof( resourceSource ) );
        Assembly assembly = resourceSource.Assembly;
        string rootPath = _pathResolver.GetResourcesRootPath( assembly , _rootPath );
        string baseName = _pathResolver.GetResourcesBaseName( assembly , resourceSource.FullName );
    ...
    public IStringLocalizer Create( string baseName , string location ) {
        ...
        AssemblyName assemblyName = new AssemblyName( location );
