...
public class CommandLine {
    ...
    public Process Execute() {
        ...
        bool done = _outputReceived.WaitOne( _timeout );
        if( !done )
            throw new SystemException( $"命令 \"{GetDebugText()}\" 超时" );
        return process;
    }
    ...
    private ProcessStartInfo CreateProcessStartInfo() {
        ...
        ProcessStartInfo result = new ProcessStartInfo( _command , escapedArgs ) {
