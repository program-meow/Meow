...
namespace Meow.Helpers
{
    ...
    public static class Reflection
    {
        ...
        {
            return GetDescription(Meow.Helpers.Common.GetType<T>());
        }
        ...
        {
            return GetDescription(Meow.Helpers.Common.GetType<T>(), memberName);
        }
        ...
        public static string GetDescription(Type type, string memberName)
        {
            if (type == null)
                return string.Empty;
            if (Meow.Helpers.Validation.IsEmpty(memberName))
                return string.Empty;
        ...
        {
            return GetDisplayName(Meow.Helpers.Common.GetType<T>());
        }
        ...
        {
            return GetDisplayNameOrDescription(Meow.Helpers.Common.GetType<T>());
        }
        ...
        public static string GetDisplayNameOrDescription(MemberInfo member)
        {
            ...
            return Meow.Helpers.Validation.IsEmpty(result) ? GetDescription(member) : result;
        }
        ...
        {
            return Meow.Helpers.Convert.To<T>(Activator.CreateInstance(type, parameters));
        }
        ...
        public static List<Type> GetDirectInterfaceTypes(Type type, params Type[] baseInterfaceTypes)
        {
            ...
            List<Type> directInterfaceTypes = interfaceTypes.Except(interfaceTypes.SelectMany(t => t.GetInterfaces())).ToList();
            if (baseInterfaceTypes == null || baseInterfaceTypes.Length == 0)
                return directInterfaceTypes;
            List<Type> result = new List<Type>();
            foreach (Type interfaceType in directInterfaceTypes)
            {
        ...
        public static bool IsBool(MemberInfo member)
        {
            ...
            switch (member.MemberType)
            {
                case MemberTypes.TypeInfo:
                    return member.ToString() == TypeFullName.Bool;
        ...
        public static bool IsDate(MemberInfo member)
        {
            ...
            {
                case MemberTypes.TypeInfo:
                    return member.ToString() == TypeFullName.DateTime;
                case MemberTypes.Property:
        ...
        public static bool IsInt(MemberInfo member)
        {
            ...
            {
                case MemberTypes.TypeInfo:
                    return member.ToString() == TypeFullName.Int || member.ToString() == TypeFullName.Short || member.ToString() == TypeFullName.Long;
                case MemberTypes.Property:
        ...
        public static bool IsNumber(MemberInfo member)
        {
            ...
            {
                case MemberTypes.TypeInfo:
                    return member.ToString() == TypeFullName.Double || member.ToString() == TypeFullName.Decimal || member.ToString() == TypeFullName.Float;
                case MemberTypes.Property:
        ...
        public static Type GetElementType(Type type)
        {
            ...
            Type[] genericArgumentsTypes = type.GetTypeInfo().GetGenericArguments();
        ...
        /// </summary>
        /// <param name="type">类型</param>
        public static TypeEnum? GetTypeEnum(object type)
        {
            if (type == null)
                return null;
        ...
        /// </summary>
        /// <param name="type">类型</param>
        public static TypeEnum? GetTypeEnumByType(Type type)
        {
            if (type == null)
                return null;
        ...
        private static TypeEnum? GetTypeEnumByMemberInfo(MemberInfo memberInfo)
        {
        ...
        private static TypeEnum? GetTypeEnumByTypeInfo(TypeInfo typeInfo)
        {
            if (typeInfo.IsEnum)
                return TypeEnum.Enum;
            if (typeInfo.IsClass)
                return TypeEnum.Objects;
            switch (typeInfo.ToString())
            {
                case TypeFullName.Sbyte:
                    return TypeEnum.Sbyte;
                case TypeFullName.Byte:
                    return TypeEnum.Byte;
                case TypeFullName.Short:
                    return TypeEnum.Short;
                case TypeFullName.Ushort:
                    return TypeEnum.Ushort;
                case TypeFullName.Int:
                    return TypeEnum.Int;
                case TypeFullName.Uint:
                    return TypeEnum.Uint;
                case TypeFullName.Long:
                    return TypeEnum.Long;
                case TypeFullName.Ulong:
                    return TypeEnum.Ulong;
                case TypeFullName.Nint:
                    return TypeEnum.Nint;
                case TypeFullName.Nuint:
                    return TypeEnum.Nuint;
                case TypeFullName.Float:
                    return TypeEnum.Float;
                case TypeFullName.Double:
                    return TypeEnum.Double;
                case TypeFullName.Decimal:
                    return TypeEnum.Decimal;
                case TypeFullName.Bool:
                    return TypeEnum.Bool;
                case TypeFullName.Char:
                    return TypeEnum.Char;
                case TypeFullName.String:
                    return TypeEnum.String;
                case TypeFullName.Guid:
        ...
        private static TypeEnum? GetTypeEnumByPropertyInfo(PropertyInfo propertyInfo)
        {
        ...
        private static bool IsObjects(PropertyInfo propertyInfo)
        {
            if (propertyInfo.PropertyType.GetTypeInfo().IsClass)
                return true;
            Type value = Nullable.GetUnderlyingType(propertyInfo.PropertyType);
            if (value == null)
                return false;
