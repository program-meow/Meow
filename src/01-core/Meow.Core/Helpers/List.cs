    ...
    public static class List
    {
        ...
        public static string CamelCase(IEnumerable<string> array)
        {
            ...
            foreach (string each in array)
                result.Append(Meow.Helpers.String.FirstUpperCase(each.ToLower()));
        ...
        public static string Join<T>(IEnumerable<T> array, string quotes = "", string separator = ",")
        {
            ...
            return Meow.Helpers.String.RemoveEnd(result.ToString(), separator);
        }
        ...
        public static List<string> AddRangeNotEmpty(List<string> array, List<string> value)
        {
            ...
            if (value == null)
                return array;
            array.AddRange(value.Where(t => !Meow.Helpers.Validation.IsEmpty(t)));
            return array;
        }
        ...
        public static bool IsSequenceBy<TSource, TKey>(IEnumerable<TSource> array, Func<TSource, TKey> keySelector, int startNo = 1)
        {
            ...
            {
                var value = Meow.Helpers.Convert.ToIntOrNull(keySelector(element));
                if (value == null)
                    return false;
        ...
        {
            return IsSequence(Meow.Helpers.Common.SafeValue(array), startNo);
        }
        ...
        {
            array ??= new List<string>();
            array.RemoveAll(Meow.Helpers.Validation.IsEmpty);
            return array;
        }
        ...
        {
            array ??= new List<T>();
            array = array.Where(t => !Meow.Helpers.Validation.IsEmpty(keySelector(t))).ToList();
            return array;
        }
