...
namespace Meow.Helpers
{
    ...
    public static class Enum
    {
        ...
        {
            string value = Meow.Helpers.Common.SafeString(member);
            ...
            return (TEnum)System.Enum.Parse(Meow.Helpers.Common.GetType<TEnum>(), value, true);
        }
        ...
        {
            return GetName(Meow.Helpers.Common.GetType<TEnum>(), member);
        }
        ...
        {
            return GetValue(Meow.Helpers.Common.GetType<TEnum>(), member);
        }
        ...
        public static int? GetValue(Type type, object member)
        {
            ...
            return Meow.Helpers.Convert.To<int?>(result);
        }
        ...
        {
            return Meow.Helpers.Reflection.GetDescription<TEnum>(GetName<TEnum>(member));
        }
        ...
        {
            return Meow.Helpers.Reflection.GetDescription(type, GetName(type, member));
        }
