...
namespace Meow.Helpers
{
    ...
    public static class Convert
    {
        ...
        public static T To<T>(object value)
        {
            if (value == null)
                return default;
            if (value is string && Meow.Helpers.Validation.IsEmpty(Meow.Helpers.Common.SafeString(value)))
                return default;
            Type type = Meow.Helpers.Common.GetType<T>();
            string typeName = type.Name.ToUpperInvariant();
            try
            {
                if (typeName == Meow.Types.TypeName.String.ToLower() || typeName == Meow.Types.TypeName.Guid.ToLower())
                    return (T)TypeDescriptor.GetConverter(typeof(T)).ConvertFromInvariantString(Meow.Helpers.Common.SafeString(value));
                if (type.IsEnum)
        ...
        public static List<T> ToList<T>(IEnumerable<object> array)
        {
            ...
            if (Meow.Helpers.Validation.IsEmpty(array))
                return result;
        ...
        public static List<T> ToList<T>(string value, string separator = ",")
        {
            ...
            result.AddRange(from each in array where !Meow.Helpers.Validation.IsEmpty(each) select To<T>(each));
            return result;
        }
        ...
        {
            bool success = int.TryParse(Meow.Helpers.Common.SafeString(value), out int result);
            if (success)
                return result;
            try
            {
        ...
        {
            bool success = float.TryParse(Meow.Helpers.Common.SafeString(value), out Single result);
            if (!success)
                return null;
            if (digits == null)
                return result;
        ...
        {
            bool success = double.TryParse(Meow.Helpers.Common.SafeString(value), out double result);
            if (!success)
                return null;
            if (digits == null)
                return result;
        ...
        {
            bool success = long.TryParse(Meow.Helpers.Common.SafeString(value), out long result);
            if (success)
                return result;
            try
            {
        ...
        {
            bool success = decimal.TryParse(Meow.Helpers.Common.SafeString(value), out decimal result);
            if (!success)
                return null;
            if (digits == null)
                return result;
        ...
        {
            bool success = DateTime.TryParse(Meow.Helpers.Common.SafeString(value), out DateTime result);
            if (success == false)
                return null;
            return result;
        }
        ...
        {
            string strValue = Meow.Helpers.Common.SafeString(value);
            switch (strValue)
            {
                case "1":
                    return true;
        ...
        {
            return Guid.TryParse(Meow.Helpers.Common.SafeString(value), out Guid result) ? result : null;
        }
        ...
        public static List<Guid> ToGuidList(IEnumerable<string> array)
        {
            ...
            return array.Select(t => t.ToGuid()).ToList();
        }
        ...
        {
            return Meow.Helpers.Validation.IsEmpty(value) ? new byte[] { } : encoding.GetBytes(value);
        }
