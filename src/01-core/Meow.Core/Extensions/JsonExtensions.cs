...
namespace Meow.Extensions
{
    ...
    public static class JsonExtensions
    {
        ...
        {
            return Meow.Helpers.Json.ToJson<T>(value, options);
        }
        ...
        {
            return Meow.Helpers.Json.ToJson<T>(value, options, removeQuotationMarks, toSingleQuotes);
        }
        ...
        {
            return await Meow.Helpers.Json.ToJsonAsync<T>(value, options, cancellationToken);
        }
        ...
        {
            return Meow.Helpers.Json.ToObject<T>(json, options);
        }
        ...
        {
            return Meow.Helpers.Json.ToObject(json, returnType, options);
        }
        ...
        {
            return await Meow.Helpers.Json.ToObjectAsync<T>(json, options, cancellationToken, encoding);
        }
        ...
        /// <param name="options">序列化配置</param>
        /// <param name="cancellationToken">取消令牌</param>
        public static async Task<T> ToJsonObjectAsync<T>(this Stream json, JsonSerializerOptions options = null, CancellationToken cancellationToken = default)
        {
            return await Meow.Helpers.Json.ToObjectAsync<T>(json, options, cancellationToken);
        }
    }
}
