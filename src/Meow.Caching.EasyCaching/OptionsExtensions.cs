...
public static class OptionsExtensions
{
    ...
    public static Options UseMemoryCache(this Options options, System.Action<InMemoryOptions> setupAction)
    {
    ...
    public static Options UseRedisCache(this Options options, System.Action<RedisOptions> setupAction)
    {
