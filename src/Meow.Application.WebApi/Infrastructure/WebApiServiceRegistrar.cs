...
using Meow.Application.WebApi.Logging;
...
namespace Meow.Application.WebApi.Infrastructure;
...
public class WebApiServiceRegistrar : IServiceRegistrar
{
    ...
    /// 获取服务名
    /// </summary>
    public static string ServiceName => "Meow.Applications.Infrastructure.WebApiServiceRegistrar";
