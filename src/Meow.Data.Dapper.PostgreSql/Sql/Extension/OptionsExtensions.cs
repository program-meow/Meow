...
public static class OptionsExtensions
{
        ...
        where TImplementation : PostgreSqlQueryBase, TService
    {
        ...
        options.AddExtension(new PostgreSqlQueryOptionExtension<TService, TImplementation>(sqlOptions));
        return options;
    }
    ...
    public static Options UsePgSqlExecutor<TService, TImplementation>(this Options options, Action<SqlOptions> setupAction)
        ...
        where TImplementation : PostgreSqlExecutorBase, TService
    {
        SqlOptions<TImplementation> sqlOptions = new SqlOptions<TImplementation>();
        setupAction?.Invoke(sqlOptions);
        options.AddExtension(new PostgreSqlExecutorOptionExtension<TService, TImplementation>(sqlOptions));
        return options;
    }
