...
public static class OptionExtensions
{
        ...
        where TImplementation : MySqlQueryBase, TService
    {
        ...
        options.AddExtension(new MySqlQueryOptionExtension<TService, TImplementation>(sqlOptions));
        return options;
    }
        ...
        where TImplementation : MySqlExecutorBase, TService
    {
        var sqlOptions = new SqlOptions<TImplementation>();
        setupAction?.Invoke(sqlOptions);
        options.AddExtension(new MySqlExecutorOptionExtension<TService, TImplementation>(sqlOptions));
        return options;
    }
