...
public interface IWhereClause : ISqlClause {
    ...
    void Where( string column , object value , OperatorEnum @operator );
    /// <summary>
    /// 设置子查询条件
    /// </summary>
    /// <param name="column">列名</param>
    ...
    /// <param name="operator">运算符</param>
    void Where( string column , ISqlBuilder builder , OperatorEnum @operator );
    /// <summary>
    /// 设置子查询条件
    /// </summary>
    /// <param name="column">列名</param>
    ...
    /// <param name="operator">运算符</param>
    void Where( string column , Action<ISqlBuilder> action , OperatorEnum @operator );
    /// <summary>
    /// 设置Is Null查询条件
    /// </summary>
    /// <param name="column">列名</param>
    ...
    void Between( string column , int? min , int? max , BoundaryEnum boundary );
    /// <summary>
    /// 设置范围查询条件
    /// </summary>
    /// <param name="column">列名</param>
    ...
    /// <param name="max">最大值</param>
    /// <param name="boundary">包含边界</param>
    void Between( string column , double? min , double? max , BoundaryEnum boundary );
    /// <summary>
    /// 设置范围查询条件
    /// </summary>
    /// <param name="column">列名</param>
    ...
    /// <param name="max">最大值</param>
    /// <param name="boundary">包含边界</param>
    void Between( string column , decimal? min , decimal? max , BoundaryEnum boundary );
    /// <summary>
    /// 设置范围查询条件
    /// </summary>
    /// <param name="column">列名</param>
    ...
    /// <param name="boundary">包含边界</param>
    void Between( string column , DateTime? min , DateTime? max , bool includeTime , BoundaryEnum? boundary );
    /// <summary>
    /// 设置Exists查询条件
    /// </summary>
    /// <param name="builder">子查询Sql生成器</param>
