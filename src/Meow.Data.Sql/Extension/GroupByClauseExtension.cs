...
/// Group By子句操作扩展
/// </summary>
public static class GroupByClauseExtension
{
    ...
    public static T Having<T>(this T source, string expression, object value, OperatorEnum @operator = OperatorEnum.Equal, bool isParameterization = true) where T : IGroupBy
    {
        source.CheckNull(nameof(source));
        if (source is ISqlPartAccessor accessor)
