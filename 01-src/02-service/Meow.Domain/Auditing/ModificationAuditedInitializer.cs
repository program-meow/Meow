using System;
using Meow.Domain.Auditing.Interface;
...
namespace Meow.Domain.Auditing
{
    ...
    public class ModificationAuditedInitializer
    {
        ...
        private ModificationAuditedInitializer(object entity, string userId)
        {
            _entity = entity;
            _userId = userId;
        }
        ...
        {
            new ModificationAuditedInitializer(entity, userId).Init();
        }
